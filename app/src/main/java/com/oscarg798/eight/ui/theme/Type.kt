...
private val fontFamily = FontFamily(
    Font(resId = R.font.pacifico, weight = FontWeight.Light),
    Font(resId = R.font.pacifico, weight = FontWeight.Normal),
    Font(resId = R.font.pacifico, weight = FontWeight.Bold)
)
